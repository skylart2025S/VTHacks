...
const Shield = ({ className }: { className?: string }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.333 9-6.03 9-11.623C21 7.51 20.403 5.228 18.598 6a11.96 11.96 0 0 1-5.598-3.75Z"
    />
  </svg>
);
  ...
  const features = [
    {
      ...
      description:
        "Smart spending analysis with personalized tips to optimize your budget",
    },
    {
      icon: Trophy,
      title: "Competitive Rankings",
      description:
        "Climb the leaderboard and prove you're the ultimate budget master",
    },
    {
      icon: Target,
    ...
    },
    {
      ...
      description:
        "Live transaction monitoring with instant efficiency scoring",
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-green-950 to-slate-900 text-white overflow-hidden relative font-clash">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(34, 197, 94, 0.4) 0%, rgba(59, 130, 246, 0.3) 50%, rgba(168, 85, 247, 0.2) 100%)",
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(168, 85, 247, 0.4) 0%, rgba(236, 72, 153, 0.3) 50%, rgba(34, 197, 94, 0.2) 100%)",
          ...
          <div className="bg-gradient-to-br from-slate-900 to-green-900 border border-green-500/30 rounded-2xl p-8 w-full max-w-md">
            ...
            <div className="space-y-3 mb-6">
              {oauthProviders.map((provider) => (
                ...
                >
                  ...
                  <span>
                    {isAuthenticating ? "Connecting..." : provider.label}
                  </span>
                </button>
              ))}
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-700">
              <p className="text-xs text-gray-400 text-center">
                ...
                Policy. Your financial data is encrypted and secure.
              </p>
            </div>
          </div>
        </div>
      ...
      <section
        ref={heroRef}
        className="relative z-10 px-6 md:px-12 pt-20 pb-32"
      >
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-24">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
              Everything you need to manage shared expenses with style
            </p>
          </div>
            ...
            {features.map((feature, index) => (
              <div
                ...
                className={`group relative bg-gradient-to-br from-green-900/20 to-blue-900/20 backdrop-blur-sm border border-green-500/20 rounded-3xl p-8 hover:border-green-400/50 hover:scale-105 transition-all duration-500 cursor-pointer overflow-hidden ${
                  activeFeature === index
                    ? "ring-2 ring-green-400/50 shadow-2xl shadow-green-500/25"
                    : ""
                }`}
                style={{ animationDelay: `${index * 0.1}s` }}
              ...
              >
                ...
                <div
                  className="absolute bottom-4 left-4 w-1 h-1 bg-blue-400 rounded-full opacity-0 group-hover:opacity-100 group-hover:animate-ping transition-opacity duration-500"
          ...
          <div className="bg-gradient-to-r from-green-900/50 to-blue-900/50 backdrop-blur-sm border border-green-500/30 rounded-3xl p-16 relative overflow-hidden group">
            ...
            <div className="flex justify-center mb-8 group-hover:scale-110 transition-transform duration-500">
              {[...Array(5)].map((_, i) => (
                <Star
                  key={i}
                  className="w-10 h-10 text-yellow-400 fill-current group-hover:text-yellow-300 transition-colors duration-300"
            ...
            <p className="text-xl text-gray-300 mb-16 max-w-3xl mx-auto group-hover:text-white transition-colors duration-300 leading-relaxed">
              Join roommates everywhere who are splitting bills without
              splitting friendships. Start managing shared expenses the smart
              way.
            </p>
            ...
            <div
              className="absolute top-12 right-12 w-1 h-1 bg-blue-400 rounded-full opacity-0 group-hover:opacity-100 group-hover:animate-ping transition-opacity duration-500"
              style={{ animationDelay: "0.2s" }}
            ></div>
            <div
              className="absolute bottom-8 left-12 w-1.5 h-1.5 bg-purple-400 rounded-full opacity-0 group-hover:opacity-100 group-hover:animate-ping transition-opacity duration-500"
              style={{ animationDelay: "0.4s" }}
            ></div>
            <div
              className="absolute bottom-12 right-8 w-2 h-2 bg-pink-400 rounded-full opacity-0 group-hover:opacity-100 group-hover:animate-ping transition-opacity duration-500"
